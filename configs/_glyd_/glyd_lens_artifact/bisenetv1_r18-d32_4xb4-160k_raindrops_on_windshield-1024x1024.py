...
default_hooks = dict(
    ...
    visualization=dict(type='CustomSegVisualizationHook', draw=True, interval=1, draw_idx=1000, draw_filenames=['D3_0042_img.png', 'D3_1980_img.png', 'D3_0423_img.png', 'Extra1_0000_img.png', 'Extra2_0000_img.png'])
)
