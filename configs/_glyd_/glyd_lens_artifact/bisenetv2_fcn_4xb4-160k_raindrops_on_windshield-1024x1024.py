...
optim_wrapper = dict(
    type='OptimWrapper',
    optimizer=optimizer,
    clip_grad=dict(_delete_=True, max_norm=3)
)
# optim_wrapper = dict(
#     _delete_=True,
...
train_cfg = dict(max_iters=160000, val_interval=1000)  # Override base schedule to validate every 1000 iterations
...
vis_backends = [dict(type='LocalVisBackend'),
                ...
                dict(type='WandbVisBackend',
                    init_kwargs=dict(
                        entity='chao-jung-lai-glydways',     # workspace name
                        project='Camera Blockage Detection', # project name
                        name='bisenetv2_fcn',                # run name
                ))]
